                ...
                <div className="col-md-7 d-flex align-items-center" id="contenu_mini_bio">
                    <div className="bio-text-content">
                        ...
                        <p className="bio-paragraph">
                            Moi c'est <b>Corentin Le Roux</b>, j’ai 20 ans, je suis un étudiant de <span className="highlight-text">BUT MMI</span> et comme le dit mon nom je suis roux ! Marrant non ?
                        </p>
